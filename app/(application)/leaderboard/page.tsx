...
export default function LeaderboardPage() {
  const { isInitialized, isMiniApp, error } = useFarcasterMiniApp();
                    ...
                    >
                      <TableCell className="font-medium">
                        <div className="flex items-center gap-2">
                          {entry.rank <= 3 ? (
                            <motion.div
                              className={`w-8 h-8 rounded-full flex items-center justify-center shadow-lg ${entry.rank === 1 ? 'bg-yellow-100' :
                                entry.rank === 2 ? 'bg-gray-100' :
                                  'bg-orange-100'
                                }`}
                              whileHover={{ scale: 1.05 }}
                            >
                              <span className={`font-bold ${entry.rank === 1 ? 'text-yellow-600' :
                      ...
                      <TableCell className="text-center">
                        <motion.div
                          className={`px-3 py-1 rounded-full inline-flex items-center gap-2 ${entry.activity === 'High'
                          ...
                          whileHover={{ scale: 1.05 }}
                        >
                          <div className={`w-2 h-2 rounded-full ${entry.activity === 'High' ? 'bg-green-600' :
